...
export default function Navbar({ darkMode, setDarkMode }: NavbarProps) {
  ...
  return (
    <nav className={`${darkMode ? 'bg-black' : 'bg-gray-850'} shadow-lg fixed w-full z-50 transition-colors duration-300`}>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className={`md:hidden ${darkMode ? 'bg-black' : 'bg-gray-850'}`}>
