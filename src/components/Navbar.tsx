...
export default function Navbar({ darkMode, setDarkMode }: NavbarProps) {
  ...
  return (
    <nav className={`${darkMode ? 'bg-gradient-to-r from-black to-gray-800' : 'bg-gradient-to-r from-black to-gray-800'} shadow-lg fixed w-full z-50 transition-colors duration-300`}>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className={`md:hidden ${darkMode ? 'bg-gradient-to-r from-black to-gray-800' : 'bg-gradient-to-r from-black to-gray-800'}`}>
